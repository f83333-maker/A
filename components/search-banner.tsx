      ...
      <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto animate-fade-in-up delay-300">
          ...
          >
            ...
            <button
              type="submit"
              className="m-2 px-6 h-10 bg-transparent border border-[#7CFF00] text-[#7CFF00] font-semibold rounded-full transition-all duration-300 text-[14px] flex items-center gap-2 shrink-0 hover:bg-[#7CFF00] hover:text-black hover:shadow-[0_0_20px_rgba(124,255,0,0.3)] active:scale-95"
            >
