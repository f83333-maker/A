        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2.5 mb-5 group">
              <div className="w-8 h-8 rounded-lg bg-muted flex items-center justify-center transition-all group-hover:bg-accent/10">
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                className="w-9 h-9 rounded-xl bg-muted hover:bg-accent/10 flex items-center justify-center transition-all duration-200"
                title="Telegram"
              >
          ...
          {/* 快速链接 */}
          <div>
            <h3 className="text-[13px] font-semibold text-foreground mb-4 uppercase tracking-wider">
              快速链接
            </h3>
